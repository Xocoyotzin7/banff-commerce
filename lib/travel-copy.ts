...
export const travelCopy: Record<Locale, TravelCopy> = {
  en: {
    ...
    footer: {
      description: "Luxury travel for Latin America, with a practical commerce layer that keeps discovery, booking and conversion in the same flow.",
      aboutTitle: "About",
  ...
  fr: {
    ...
    footer: {
      description: "Voyages premium en Amérique latine, avec une couche e-commerce pratique qui garde la découverte, la réservation et la conversion dans un même flux.",
      aboutTitle: "À propos",
  ...
  es: {
    ...
    footer: {
      description: "Viajes premium por Latinoamérica, con una capa de comercio práctica que mantiene descubrimiento, reserva y conversión en un mismo flujo.",
